...
import com.example.mvp_demo.utils.NetUtil;
...
public class RetrofitService {
    ...
    public static synchronized ApiService getNewsService() {
        if (mZhifuService == null) {
            Cache cache = new Cache(new File(DailyApplication.getContext().getCacheDir(), "HttpCache"),
                    1024 * 1024 * 100);
    ...
    private static final Interceptor sRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetUtil.isNetworkAvailable(DailyApplication.getContext())) {
    ...
    private static final Interceptor sLoggingInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            //打印url信息
            Logger.w(TAG, request.url() + (request.body() != null ? "?" + _parseParams(request.body(), requestBuffer) : ""));
